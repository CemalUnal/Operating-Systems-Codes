...
/*
 ...
 _________	|						|	  Pipe - 1		 |						 |		Pipe - 2	  |						  |
|		  \	|		  Main			| -----------------\ |	 Child Process - 1	 | -----------------\ |	  Child Process - 2	  |________________
|   ______/	|   (Parent Process)	| -----------------/ |						 | -----------------/ |						  |_____________   |
|  |		|_______________________|					 |_______________________|					  |_______________________|				|  |
|  |																														                |  |
|  |																																		|  |
|  |________________________________________________________________________________________________________________________________________|  |
|_______________________________________________________________Pipe - 3_______________________________________________________________________|
																																   
			As can be seen in the figure above, if number of child processes is N, then number of pipes must be N+1.
